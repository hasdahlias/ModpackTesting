...
declare const AdvJSEvents: {
    /**
     * @at *server*
    */
betterAdv(handler: (event: Internal.BetterAdvEventJS) => void):void,
    /**
     * @at *server*
    */
advancement(handler: (event: Internal.AdvConfigureEventJS) => void):void,
    /**
     * @at *server*
    */
lock(handler: (event: Internal.AdvLockEventJS) => void):void,
    /**
     * @at *startup*
    */
trigger(handler: (event: Internal.TriggerRegistryEventJS) => void):void,
};
declare const LDLibUI: {
    /**
     * @at *server*
     * 
     * @cancellable
    */
item(extra: string, handler: (event: Internal.UIEvents$ItemUIEventJS) => void):void,
item(handler: (event: Internal.UIEvents$ItemUIEventJS) => void):void,
    /**
     * @at *server*
     * 
     * @cancellable
    */
block(extra: string, handler: (event: Internal.UIEvents$BlockUIEventJS) => void):void,
block(handler: (event: Internal.UIEvents$BlockUIEventJS) => void):void,
};
...
declare const EntityJSEvents: {
    /**
     * @at *server*
    */
buildBrain(extra: string, handler: (event: Internal.BuildBrainEventJS<any>) => void):void,
    /**
     * @at *startup*
    */
modifyEntity(handler: (event: Internal.EntityModificationEventJS) => void):void,
    /**
     * @at *server*
    */
addGoalSelectors(extra: string, handler: (event: Internal.AddGoalSelectorsEventJS<any>) => void):void,
    /**
     ...
     * @at *server*
    */
buildBrainProvider(extra: string, handler: (event: Internal.BuildBrainProviderEventJS<any>) => void):void,
    /**
     * @at *startup*
    */
attributes(handler: (event: Internal.ModifyAttributeEventJS) => void):void,
    /**
     * @at *startup*
    */
spawnPlacement(handler: (event: Internal.RegisterSpawnPlacementsEventJS) => void):void,
    /**
     * @at *server*
    */
addGoals(extra: string, handler: (event: Internal.AddGoalTargetsEventJS<any>) => void):void,
    /**
     * @at *startup*
    */
createAttributes(handler: (event: Internal.AttributeCreationEventJS) => void):void,
    /**
     * @at *server*
    */
biomeSpawns(handler: (event: Internal.BiomeSpawnsEventJS) => void):void,
};
...
registry(type: "apoli:bientity_action", handler: (event: Registry.BientityAction) => void):void,
registry(type: "apoli:bientity_condition", handler: (event: Registry.BientityCondition) => void):void,
registry(type: "apoli:biome_condition", handler: (event: Registry.BiomeCondition) => void):void,
registry(type: "apoli:block_action", handler: (event: Registry.BlockAction) => void):void,
registry(type: "apoli:block_condition", handler: (event: Registry.BlockCondition) => void):void,
registry(type: "apoli:configured_bientity_action", handler: (event: Registry.ConfiguredBientityAction) => void):void,
registry(type: "apoli:configured_bientity_condition", handler: (event: Registry.ConfiguredBientityCondition) => void):void,
registry(type: "apoli:configured_biome_condition", handler: (event: Registry.ConfiguredBiomeCondition) => void):void,
registry(type: "apoli:configured_block_action", handler: (event: Registry.ConfiguredBlockAction) => void):void,
registry(type: "apoli:configured_block_condition", handler: (event: Registry.ConfiguredBlockCondition) => void):void,
registry(type: "apoli:configured_damage_condition", handler: (event: Registry.ConfiguredDamageCondition) => void):void,
registry(type: "apoli:configured_entity_action", handler: (event: Registry.ConfiguredEntityAction) => void):void,
registry(type: "apoli:configured_entity_condition", handler: (event: Registry.ConfiguredEntityCondition) => void):void,
registry(type: "apoli:configured_fluid_condition", handler: (event: Registry.ConfiguredFluidCondition) => void):void,
registry(type: "apoli:configured_item_action", handler: (event: Registry.ConfiguredItemAction) => void):void,
registry(type: "apoli:configured_item_condition", handler: (event: Registry.ConfiguredItemCondition) => void):void,
registry(type: "apoli:configured_modifier", handler: (event: Registry.ConfiguredModifier) => void):void,
registry(type: "apoli:configured_power", handler: (event: Registry.ConfiguredPower) => void):void,
registry(type: "apoli:damage_condition", handler: (event: Registry.DamageCondition) => void):void,
registry(type: "apoli:entity_action", handler: (event: Registry.EntityAction) => void):void,
registry(type: "apoli:entity_condition", handler: (event: Registry.EntityCondition) => void):void,
registry(type: "apoli:fluid_condition", handler: (event: Registry.FluidCondition) => void):void,
registry(type: "apoli:global_power_set", handler: (event: Registry.GlobalPowerSet) => void):void,
registry(type: "apoli:item_action", handler: (event: Registry.ItemAction) => void):void,
registry(type: "apoli:item_condition", handler: (event: Registry.ItemCondition) => void):void,
registry(type: "apoli:modifier", handler: (event: Registry.Modifier) => void):void,
registry(type: "apoli:power_factory", handler: (event: Registry.PowerFactory) => void):void,
registry(type: "calio:player_ability", handler: (event: Registry.PlayerAbility) => void):void,
...
registry(type: "origins:badge_factory", handler: (event: Registry.BadgeFactory) => void):void,
registry(type: "origins:origins", handler: (event: Registry.Origins) => void):void,
